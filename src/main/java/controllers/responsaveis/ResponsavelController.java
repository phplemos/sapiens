...
import views.responsaveis.ResponsavelFormView;
...
public class ResponsavelController {
    ...
    private ResponsavelFormView formView; // O formulário de popup
    ...
    public ResponsavelController(ResponsavelListView listView) {
        ...
        this.formView = new ResponsavelFormView(this.listView);
