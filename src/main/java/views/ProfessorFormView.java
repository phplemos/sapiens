...
public class ProfessorFormView extends JDialog {
    ...
    public ProfessorFormView(Window parent) {
    ...
    public void setPessoaIdParaEdicao(int id) { this.pessoaIdParaEdicao = id; }
    public int getPessoaIdParaEdicao() { return this.pessoaIdParaEdicao; }
    ...
    public boolean validateForm(boolean isEdicao){
        ...
        if(txtRg.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o rg do Professor!");
            return true; // Por enquanto liberado
        }
        if(txtDataNasc.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o data de nascimento do Professor!");
            return false;
        }
        if(txtTelefone.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o telefone do Professor!");
            return false;
        }
        if(txtEmail.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o email do Professor!");
            return true; // Por enquanto liberado
        }
        if(txtLogradouro.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o logradouro do Professor!");
            return false;
        }
        if(txtNumero.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o numero do Professor!");
            return false;
        }
        if(txtBairro.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o bairro do Professor!");
            return false;
        }
        if(txtCidade.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Preencha o cidade do Professor!");
            return false;
        }
        return true;
    }
